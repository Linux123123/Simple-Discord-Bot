    ...
    permLevels: [
        ...
        // This is your permission level, the staff levels should always be above the rest of the roles.
        {
            ...
            check: (message) => {
                var _a, _b;
                try {
                    const modRole = (_a = message.guild) === null || _a === void 0 ? void 0 : _a.roles.cache.find((r) => r.name.toLowerCase() ===
                        message.settings.modRole.toLowerCase());
                    if (modRole && ((_b = message.member) === null || _b === void 0 ? void 0 : _b.roles.cache.has(modRole.id)))
                        return true;
                    return false;
                }
                catch (e) {
        ...
        },
        {
            ...
            check: (message) => {
                var _a;
                try {
                    const adminRole = (_a = message.guild) === null || _a === void 0 ? void 0 : _a.roles.cache.find((r) => r.name.toLowerCase() ===
        ...
        // This is the server owner.
        {
            ...
            check: (message) => {
                ...
                return message.channel.type === 'text'
                    ? ((_a = message.guild) === null || _a === void 0 ? void 0 : _a.ownerID) === message.author.id
                        ? true
                        : false
                    : false;
            },
